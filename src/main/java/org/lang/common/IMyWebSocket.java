...
public interface IMyWebSocket {
     ...
     *
     * @param session       会话
     * @param binaryMessage 接收的消息
     */
    void handleMessage(WebSocketSession session, BinaryMessage binaryMessage);
     ...
     * @throws IOException
     */
    void sendMessage(String userId, BinaryMessage binaryMessage) throws IOException;
     ...
     *
     * @param session       当前会话
     * @param binaryMessage 要发送的消息
     * @throws IOException 发送io异常
     */
    void sendMessage(WebSocketSession session, BinaryMessage binaryMessage) throws IOException;
